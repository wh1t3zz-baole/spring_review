...
/**
 * @author mac guopan
 * @description spring_review AdminSerivceProxy
 * @date 2021/10/21 7:34 下午
 */

public class AdminSerivceProxy implements AdminService{

    private AdminService adminService;

    public AdminSerivceProxy(AdminService adminService) {
